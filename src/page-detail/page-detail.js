...
class PageDetail {
    ...
    async show(matches) {
        ...
        this._recordVertrag = matches[1];
        this._data = await this._app.database.selectAllContracts();
        ...
        this._app.setPageTitle(`Vertrag ${this._recordVertrag}`, {isSubPage: true});
    ...
    async _renderPosts(pageDom) {
        ...
        this._data.forEach(post => {
            if (this._recordVertrag === post.land) {
